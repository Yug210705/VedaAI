...
export default function AssignmentOutput() {
  ...
  return (
    <div className="h-full flex flex-col relative print:bg-white print:p-0 bg-background overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto pb-8 print:overflow-visible px-4 relative flex flex-col items-center">
        
        {/* Dark Box Header */}
        <div className="w-full max-w-[794px] bg-[#2d2d2d] text-white rounded-2xl md:rounded-t-3xl md:rounded-b-[8px] p-4 md:p-6 mt-2 print:hidden relative z-0 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-4">
        ...
        <div className="flex flex-col items-center w-full pb-24">
          <div className="w-full max-w-[794px] min-h-[1123px] h-max bg-white shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-2xl md:rounded-[24px] p-6 sm:p-10 md:p-[60px] text-[#222] font-sans relative overflow-hidden">
            <div className="text-center mb-6 md:mb-8">
              ...
              <h3 className="text-[12px] md:text-[16px] font-semibold">Class: {assignment?.studentClass || '5th'}</h3>
            </div>
            ...
            <div className="space-y-2 font-semibold text-[10px] md:text-[14px] mb-8 md:mb-12">
              ...
              <p>Class: {assignment?.studentClass || '5th'} Section: _____________________</p>
            </div>

            {generatedQuestions.length === 0 ? (
              <p className="text-center text-gray-400 italic text-[10px] md:text-[14px]">No AI generated questions found for this assignment.</p>
            ) : (
