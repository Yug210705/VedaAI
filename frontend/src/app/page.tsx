...
import { 
  ...
  ChevronRight, MoreVertical, Sparkles, Plus, Users 
} from 'lucide-react';
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        {/* Top Metrics Row */}
        <div className="grid grid-cols-2 xl:flex xl:flex-row gap-3 md:gap-4 mb-6 md:mb-8 pb-1">
          
          {/* Card 1: Assignments Reviewed */}
          <div className="col-span-1 bg-[#2d2d2d] rounded-[20px] md:rounded-[24px] px-3.5 md:px-5 py-4 md:p-6 text-white flex flex-col xl:flex-row items-center justify-between xl:flex-1 shadow-sm relative overflow-hidden h-[145px] md:h-[155px]">
          ...
          <div className="col-span-1 bg-[#2d2d2d] rounded-[20px] md:rounded-[24px] px-3 py-4 md:p-6 text-white flex flex-col items-center justify-center xl:flex-1 shadow-sm relative h-[145px] md:h-[155px]">
          ...
          <div className="col-span-2 bg-white rounded-[20px] md:rounded-[24px] pl-5 pr-3 py-4 md:pl-6 md:pr-4 flex flex-row items-center justify-between xl:flex-[1.2] shadow-sm relative h-[130px] md:h-[155px] overflow-hidden">
        ...
        <div className="mb-5 flex items-center justify-between gap-2 pr-12 md:pr-0">
          <div className="flex items-center gap-2 shrink-1 min-w-0">
            <div className="w-2 h-2 bg-[#48c774] rounded-full shrink-0"></div>
            ...
            {displayAssignments.map((assignment: any, index: number) => {
              ...
              return (
                <div 
                  ...
                  className="bg-white rounded-[24px] p-5 md:p-6 pb-6 md:pb-7 shadow-sm flex flex-col justify-between min-h-[170px] md:h-[180px] cursor-pointer hover:shadow-md transition-all relative overflow-hidden"
                ...
                >
                  <div className="flex justify-between items-center mb-2 gap-2">
                    ...
                    <button className="text-gray-400 hover:text-gray-700 transition-colors p-1 shrink-0 -mr-2">
                  ...
                  <div className="flex justify-between items-end mt-auto pb-3 gap-2">
                    ...
                    <div className="text-right flex flex-col justify-end gap-1.5 overflow-hidden pb-[2px]">
                      <span className="text-[9.5px] md:text-[11px] font-bold text-[#9ca3af] tracking-wide whitespace-nowrap truncate leading-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-4">
          ...
          <div className="bg-white rounded-[20px] md:rounded-[24px] p-5 md:p-6 shadow-sm border border-[#ff512f] flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-4 relative h-auto md:h-[130px] min-h-[150px] md:min-h-0">
          ...
          <div className="bg-white rounded-[20px] md:rounded-[24px] p-5 md:p-6 shadow-sm border border-gray-100 flex flex-row items-center justify-between gap-3 md:gap-4 relative h-auto md:h-[130px] min-h-[140px] md:min-h-0">
